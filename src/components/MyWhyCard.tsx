      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-pink-400 to-purple-500 rounded-3xl p-8 z-50 max-w-md w-[90%] mx-auto shadow-2xl"
          >
            <div className="text-center space-y-6 text-white">
              ...
              <button
                onClick={onClose}
                className="w-full bg-white text-purple-600 rounded-xl py-4 hover:bg-gray-100 transition-colors shadow-lg"
              >
